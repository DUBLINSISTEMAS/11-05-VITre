...
- **Pendente Onda L6** (plano alinhado com founder 2026-05-29): L6 Cleanup vocabulário (cupons sem uso, atributos `/admin/atributos`, coerência final entre código e UI, possível normalização Pedido→Venda em schema TS).
