...
- **Próxima fase**: **Fase 5 — PDV/balcão** (ADR-0016 a ser escrito). Canal de pedido balcão (não-WhatsApp), UI de venda rápida, registra `payment_method` como metadado + cria `stock_movement` type=sale com `reference_type='balcao'`.
