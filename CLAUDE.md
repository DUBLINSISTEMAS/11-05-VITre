...
- **Pendente Ondas L5-L6** (plano alinhado com founder 2026-05-29): L5 Loja online opt-in (grupo 4 colapsa se loja não tem storefront publicado), L6 Cleanup vocabulário (cupons sem uso, atributos, coerência final).
