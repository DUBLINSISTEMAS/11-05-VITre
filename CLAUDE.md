...
- **Port Dublin v3 (BAGY-style) REABERTO em 2026-05-17 tarde** pra **HIGH-FIDELITY pixel-perfect total** ([ADR-0019](docs/decisoes/0019-port-dublin-v3-bagy-style.md) será revisado). Ondas 0-5i fechadas em prod (`6079bec..e918e57`) entregaram ~10-15% do alvo — fizeram **token sweep + sidebar 248px + login split + onboarding 4-passos**, NÃO o pixel-perfect que o README oficial pede (`PIXEL PERFECT/design_handoff_dublin_v3/README.md`: `Fidelidade: HIGH-FIDELITY. Cores exatas, tipografia definida, espaçamentos pixel-perfect, componentes finalizados.`). Founder reabriu escopo pra Caminho A: **44 telas pixel-perfect + módulos novos com backend novo** (Atributos / Cupons / Grupos cliente / Equipe multi-user 3 roles / Assinatura / Suporte). Override consciente do framing `vitre-substitui-excel-whatsapp-nao-bling`. Brand admin **carvão → navy** `#1A3A8F`; `--brand-store` por loja preservado (ADR-0011). Memory team `dublin-v3-pixel-perfect-port-2026-05-17` lista plano A.1→A.17 + B.1→B.7. Próximas ondas exigem ADRs novos (ADR-0020 Atributos / 0021 Cupons / 0022 Grupos cliente / 0023 Equipe que **quebra invariante "Better Auth somente lojista"**).
