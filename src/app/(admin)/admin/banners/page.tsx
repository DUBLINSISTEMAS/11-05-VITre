...
export default async function BannersPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <AdminPageHeader
        title="Banners"
        subtitle={`Imagens grandes que aparecem no topo da sua vitrine. Até ${MAX_BANNERS} banners. Com 2 ou mais ativos, eles trocam automaticamente em carrossel — ajuste o tempo em Configurações → Banners.`}
      />
