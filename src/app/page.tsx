 ...
 *
 * Mangos Pay = loja online com checkout WhatsApp pra pequenas lojas de
 * moda, joia, semijoia e perfumaria. Sem gateway próprio — a venda
 * continua acontecendo no WhatsApp do lojista, a loja online só organiza
      ...
      <section className="flex-1">
        <div className="mx-auto w-full max-w-3xl px-5 pb-16 pt-12 sm:px-8 sm:pt-20">
          ...
          <p className="text-muted-foreground mt-5 max-w-xl text-[15px] leading-[1.55] sm:text-base">
            ...
            a loja online num link só. O cliente escolhe, fecha o pedido,
            e a conversa cai direto no seu WhatsApp.
          </p>
...
const FEATURES = [
  ...
  },
  {
    ...
    body: "Você cobra como já cobra hoje. A Mangos Pay só organiza a vitrine — quem vende continua sendo você.",
  },
] as const;
