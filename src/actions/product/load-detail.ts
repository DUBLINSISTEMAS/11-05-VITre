...
// Removido `loadProductFormOptions`: o ProductDialog agora recebe
// categorias do SSR (page.tsx) e o modo create abre sem round-trip.
// Caso uma feature futura precise de opções dinâmicas client-side,
// expor via novo action em `actions/product/load-options.ts`.
