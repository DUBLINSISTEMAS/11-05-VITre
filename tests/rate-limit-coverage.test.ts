...
const READS_AND_HELPERS_ALLOWLIST: ReadonlyArray<string> = [
  ...
  // "load-for-custo.ts" removido em Onda L1 (2026-05-29) — tela de custos deletada.
  "load-overview.ts", // financeiro/load-overview.ts — Onda L2: KPIs do mes (saldo, recebido, pago, em aberto)
